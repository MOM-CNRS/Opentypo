-- Données de référence par défaut (idempotent)
-- Types d'entité, groupes GroupEnum, langues fr/en, utilisateur admin / admin
-- Rejoué au démarrage si données manquantes (voir DefaultReferenceDataInitializer).

-- Types d'entité typologiques (V5 + V6)
